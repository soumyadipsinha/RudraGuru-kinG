            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className={`px-2 py-1 rounded-full text-sm ${
                  product.inStock ? 'bg-transparent border border-yellow-400 text-yellow-800' : 'bg-red-100 text-red-800'
                }`}>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                {product.discount > 0 && (
                  <span className="text-lg text-yellow-600 font-semibold">Save ₹{(product.originalPrice - product.price).toLocaleString()}</span>
                )}
              </div>
            </div>
