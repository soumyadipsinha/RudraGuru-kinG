...
const gemstones = [
  ...
  // New Gemstones with Latest Assets
  {
    id: 21,
...
const filterOptions = {
  name: [
    ...
    "Moonstone", "Peridot", "Coral", "Tigers Eye", "Turquoise", "Zircon", "Diamond",
    "Cat's Eye", "Lehsunia", "Moti", "Neelam", "Pukhraj", "Manik", "Fire Opal"
  ],
  color: ["Aqua", "Blue", "Brown", "Green", "Maroon", "Orange", "Purple", "Red", "White", "Yellow", "Honey", "Multi-color", "Multi"],
